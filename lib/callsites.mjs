 ...
 * @bun 🟡  Partially compatible with Bun. When obtaining the `lineNumber`, `bun` skips
 ...
 * @returns {Callsites.ExpandedCallSite[]} Array of {@link ExpandedCallSite} providing
 *                                         detailed information about each call site.
 */
 ...
 * @returns {Callsites.ExpandedCallSite} {@link ExpandedCallSite} providing detailed
